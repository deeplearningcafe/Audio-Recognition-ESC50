...
class TrainingApp:
    def __init__(self, sys_argv=None):
        ...
        parser.add_argument('comment',
                            ...
                            nargs='?',
                            default='CNNModel_BaseModelV3_Test_NoFolds_Augmented_8000',
                            )
    ...
    def main(self):
        ...
        for epoch in range(1, self.cli_args.epochs + 1):
            ...
            train_loader = self.initTrain(self.fold)
            val_loader = self.initVal(self.fold)
            ...
            if epoch == 1 or epoch % 2 == 0:
                ...
                for name, loader in [("train", train_loader), ("val", val_loader)]:
                    ...
                    with torch.no_grad():  # <1> to not update the parameters as we are validating
    ...
    def logMetrics(self, epoch, phase, batch_metrics, totalTrainingSamples_count):
        #print(batch_metrics[:, 0], "loss before dividing")
        loss_val = None
